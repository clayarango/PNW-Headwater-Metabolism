setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/ST2jul18")
install.packages("chron")
library(chron)
StreamData=read.table("ST2jul18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/02/18", times="17:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/04/18", times="10:20:00")), ], 
  z=0.114, 
  bp=727, 
  ts=0.0034722, 
  K=175.315547)
