setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/HO26jun18")
install.packages("chron")
library(chron)
StreamData=read.table("HO26jun18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="06/26/18", times="19:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="06/28/18", times="12:40:00")), ], 
  z=0.054, 
  bp=725, 
  ts=0.0034722, 
  K=137.883107)
