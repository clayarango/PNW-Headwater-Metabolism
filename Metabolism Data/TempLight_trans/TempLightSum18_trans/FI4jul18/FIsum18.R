setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/FI4jul18")
install.packages("chron")
library(chron)
StreamData=read.table("FI4jul18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/04/18", times="17:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/06/18", times="12:00:00")), ], 
  z=0.040, 
  bp=725, 
  ts=0.0034722, 
  K=118.995357)
