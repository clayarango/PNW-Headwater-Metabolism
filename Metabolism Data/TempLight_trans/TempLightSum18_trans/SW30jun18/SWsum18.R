setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/SW30jun18")
install.packages("chron")
library(chron)
StreamData=read.table("SW30jun18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="06/30/18", times="17:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/02/18", times="10:30:00")), ], 
  z=0.050, 
  bp=710, 
  ts=0.0034722, 
  K=249.141758
