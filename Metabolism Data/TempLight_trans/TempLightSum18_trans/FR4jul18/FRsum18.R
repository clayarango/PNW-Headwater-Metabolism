setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/FR4jul18")
install.packages("chron")
library(chron)
StreamData=read.table("FR4jul18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/04/18", times="17:20:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/06/18", times="11:45:00")), ], 
  z=0.072, 
  bp=723, 
  ts=0.0034722, 
  K=212.378159)
