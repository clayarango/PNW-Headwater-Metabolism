setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/HU28jun18")
install.packages("chron")
library(chron)
StreamData=read.table("HU28jun18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="06/28/18", times="17:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="06/30/18", times="12:30:00")), ], 
  z=0.056, 
  bp=724, 
  ts=0.0034722, 
  K=80.768051)
