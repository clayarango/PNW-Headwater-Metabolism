setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum18_trans/IR28jun18")
install.packages("chron")
library(chron)
StreamData=read.table("IR28jun18.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
