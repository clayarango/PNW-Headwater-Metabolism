setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/SW23jul17")
install.packages("chron")
library(chron)
StreamData=read.table("SW23jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/23/17", times="18:30:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/25/17", times="10:00:00")), ], 
  z=0.120, 
  bp=710, 
  ts=0.006944, 
  K=99.966963)
