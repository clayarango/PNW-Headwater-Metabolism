setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/FI28jul17")
install.packages("chron")
library(chron)
StreamData=read.table("FI28jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/28/17", times="19:49:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/30/17", times="08:59:00")), ], 
  z=0.060, 
  bp=725, 
  ts=0.006944, 
  K=118.995357)
