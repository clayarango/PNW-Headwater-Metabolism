setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/FR28jul17")
install.packages("chron")
library(chron)
StreamData=read.table("FR28jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/28/17", times="20:47:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/30/17", times="08:57:00")), ], 
  z=0.073, 
  bp=723, 
  ts=0.006944, 
  K=212.378159)
