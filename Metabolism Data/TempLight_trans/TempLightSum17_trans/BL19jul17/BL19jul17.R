setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/BL19jul17")
install.packages("chron")
library(chron)
StreamData=read.table("BL19jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/19/17", times="18:55:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/21/17", times="08:45:00")), ], 
  z=0.048, 
  bp=727, 
  ts=0.006944, 
  K=80.768051)
