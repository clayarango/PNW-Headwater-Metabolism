setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/HO19jul17")
install.packages("chron")
library(chron)
StreamData=read.table("HO19jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/19/17", times="18:47:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/21/17", times="09:17:00")), ], 
  z=0.070, 
  bp=725, 
  ts=0.006944, 
  K=137.883107)
