setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightSum17_trans/MI25jul17")
install.packages("chron")
library(chron)
StreamData=read.csv("MI25jul17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="07/25/17", times="18:08:00")) & StreamData $dtime<=as.numeric(chron(
    dates="07/27/17", times="11:28:00")), ], 
  z=0.100, 
  bp=717, 
  ts=0.006944, 
  K=118.995357)
