setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/FR16nov17")
install.packages("chron")
library(chron)
StreamData=read.table("FR16nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/16/17", times="15:55:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/19/17", times="12:30:00")), ], 
  z=0.060, 
  bp=723, 
  ts=0.0034722, 
  K=212.378159)
