setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/IR10nov17")
install.packages("chron")
library(chron)
StreamData=read.table("IR10nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/10/17", times="15:30:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/12/17", times="10:00:00")), ], 
  z=0.080, 
  bp=723, 
  ts=0.0034722, 
  K=61.352979)
