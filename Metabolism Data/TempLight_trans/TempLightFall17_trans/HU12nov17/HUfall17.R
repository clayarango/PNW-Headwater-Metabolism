setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/HU12nov17")
install.packages("chron")
library(chron)
StreamData=read.table("HU12nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/12/17", times="15:30:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/14/17", times="11:15:00")), ], 
  z=0.046, 
  bp=724, 
  ts=0.0034722, 
  K=80.768051)
