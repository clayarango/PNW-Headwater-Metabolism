setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/JA7nov17")
install.packages("chron")
library(chron)
StreamData=read.table("JA7nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
