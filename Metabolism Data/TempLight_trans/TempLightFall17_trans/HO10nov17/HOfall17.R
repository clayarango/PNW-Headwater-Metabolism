setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/HO10nov17")
install.packages("chron")
library(chron)
StreamData=read.table("HO10nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
# 5 MIN timestep!! literature k600 values based on slope
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/10/17", times="15:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/12/17", times="10:05:00")), ], 
  z=0.070, 
  bp=725, 
  ts=0.0034722, 
  K=137.883107)
