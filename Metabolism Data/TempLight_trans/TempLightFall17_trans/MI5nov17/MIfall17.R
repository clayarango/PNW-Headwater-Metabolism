setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/MI5nov17")
install.packages("chron")
library(chron)
StreamData=read.table("MI5nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/05/17", times="14:54:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/07/17", times="07:04:00")), ], 
  z=0.088, 
  bp=717, 
  ts=0.0034722, 
  K=118.995357)
