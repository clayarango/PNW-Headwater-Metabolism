setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/ST5nov17")
install.packages("chron")
library(chron)
StreamData=read.table("ST5nov17.csv",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/05/17", times="16:07:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/07/17", times="08:07:00")), ], 
  z=0.170, 
  bp=727, 
  ts=0.0034722, 
  K=175.315547)
