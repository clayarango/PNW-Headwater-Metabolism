setwd("N:/Thesis.N/FreshStart_trans/TempLight_trans/TempLightFall17_trans/BL7nov17")
install.packages("chron")
library(chron)
StreamData=read.table("BLb7nov17.txt",header=TRUE)  	##time is in seconds since 1970 and in UTC
...
rivermetab(o2file=StreamData[StreamData$dtime>=as.numeric(chron(
  dates="11/07/17", times="15:10:00")) & StreamData $dtime<=as.numeric(chron(
    dates="11/08/17", times="23:55:00")), ], 
  z=0.038, 
  bp=727, 
  ts=0.0034722, 
  K=80.768051)
